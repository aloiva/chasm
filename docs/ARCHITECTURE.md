...
Session Hub uses a **source adapter pattern** to unify session data from multiple AI coding tools into one UI. Each tool is a Rust struct implementing the `SessionSource` trait.
